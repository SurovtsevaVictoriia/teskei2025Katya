...
В 4:30 был общий подъём и сбор лагеря параллельно с группой Алексея. Сперва собирались с фонариками, так как ещё была луна на небе, после чего стало ясно, без осадков и ветра. В 5:30 вышли чуть раньше дружественной группы. Первый день похода, когда участника n не горняшит, она узнала, что мы находимся в горах. Благодаря этому темп был активнее, чем в прошлые дни
...
\begin{figure}[h!]
	\begin{minipage}[h!]{0.49\linewidth}
		\centering{\includegraphics[width=0.98\linewidth]{../pics/days/11_1}}
	\end{minipage}
	\hfill
	\begin{minipage}[h!]{0.49\linewidth}
		\centering{\includegraphics[width=0.98\linewidth]{../pics/days/11_2}}
	\end{minipage}
	\caption{Движение группы по треку.Наша группа (руководитель) нашёл череп горного козла и взял его с собой. Звать его Кардинал.}
	\label{fig:09_8}
\end{figure}
...
%\begin{figure}[h!]
%	\centering
%	\includegraphics[angle=0, width=0.4\linewidth]{../pics/days/11_2.jpg}
%	\label{fig:11_2}
...
\begin{figure}[h!]
	\begin{minipage}[h!]{0.49\linewidth}
		\centering{\includegraphics[width=0.98\linewidth]{../pics/days/11_3}}
	\end{minipage}
	\hfill
	\begin{minipage}[h!]{0.49\linewidth}
		\centering{\includegraphics[width=0.98\linewidth]{../pics/days/11_4}}
	\end{minipage}
	\caption{Группа на спуске к обеду. Вдали видно вершину Марс и озеро, у которого был обед. Группа после обеда идёт вдоль озера к МН8.}
	\label{fig:09_8}
\end{figure}
...
\begin{figure}[h!]
	\begin{minipage}[h!]{0.49\linewidth}
		\centering{\includegraphics[width=0.98\linewidth]{../pics/days/11_5}}
	\end{minipage}
	\hfill
	\begin{minipage}[h!]{0.49\linewidth}
		\centering{\includegraphics[width=0.98\linewidth]{../pics/days/11_6}}
	\end{minipage}
	\caption{Группа на подъёме.Группа на вершине. Сзади ледовый купол и д.р Арабель-Суу.}
	\label{fig:09_8}
\end{figure}
