...
\begin{figure}[h!]
	\centering
	\includegraphics[angle=0, width=0.6\linewidth]{../pics/maps/12_map.jpg}
	\label{fig:12_map}
...
\begin{figure}[h!]
	\begin{minipage}[h!]{0.49\linewidth}
		\centering{\includegraphics[width=0.98\linewidth]{../pics/days/12_1}}
	\end{minipage}
	\hfill
	\begin{minipage}[h!]{0.49\linewidth}
		\centering{\includegraphics[width=0.98\linewidth]{../pics/days/12_2}}
	\end{minipage}
	\caption{Грязевые топи рядом с МН8. Вид в сторону МН, на в. Марс.}
	\label{fig:09_8}
\end{figure}
...
\begin{figure}[h!]
	\begin{minipage}[h!]{0.49\linewidth}
		\centering{\includegraphics[width=0.98\linewidth]{../pics/days/12_7}}
	\end{minipage}
	\hfill
	\begin{minipage}[h!]{0.49\linewidth}
		\centering{\includegraphics[width=0.98\linewidth]{../pics/days/12_8}}
	\end{minipage}
	\caption{С двух сторон катятся камни и эффектно тают снежники. Начало спуска.}
	\label{fig:09_8}
\end{figure}
...
\begin{figure}[h!]
	\begin{minipage}[h!]{0.49\linewidth}
		\centering{\includegraphics[width=0.98\linewidth]{../pics/days/12_9}}
	\end{minipage}
	\hfill
	\begin{minipage}[h!]{0.49\linewidth}
		\centering{\includegraphics[width=0.98\linewidth]{../pics/days/12_10}}
	\end{minipage}
	\caption{Группа идёт по сыпухе. После сыпухи начинается зелёный участок, и идёт он вплоть до долины.}
	\label{fig:09_8}
\end{figure}
...
%\end{figure}
В 15:20	( 3325 м.) группа встала на обед. Во время обеда до нас доходит группа Алексея Остапива и встают тут на место ночёвки. Наша группа, дабы силы ещё есть и идти в последний день хочется как можно меньше, принимает решение после обеда продолжить движение вниз к долине к МН10.

 В 17:38 продолжаем движение. Спуск не представляет сложности. Он приятный и простой, одна сплошная трава с протоптанными тропинками.
...
\begin{figure}[h!]
	\begin{minipage}[h!]{0.49\linewidth}
		\centering{\includegraphics[width=0.98\linewidth]{../pics/days/12_11}}
	\end{minipage}
	\hfill
	\begin{minipage}[h!]{0.49\linewidth}
		\centering{\includegraphics[width=0.98\linewidth]{../pics/days/12_12}}
	\end{minipage}
	\caption{Место обеда с видом на спуск с перевала Кашка-Суу.}
	\label{fig:09_8}
\end{figure}
