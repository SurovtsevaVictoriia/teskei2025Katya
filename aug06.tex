...
\begin{figure}[h!]
	\begin{minipage}[h!]{0.49\linewidth}
		\centering{\includegraphics[width=0.7\linewidth]{../pics/days/06-08/IMG_8775.jpg}}
	\end{minipage}
	\hfill
	\begin{minipage}[h!]{0.49\linewidth}
...
\begin{figure}[h!]
	...
	\end{minipage}
	\caption{Группа на перевале Кашкатор Северный. Вид на д.р. Кичи-Кызыл-Суу. Вид на д.р. Кашка-Тёр.}
	\label{fig:06_5}
\end{figure}
...
\begin{figure}[h!]
	...
	\hfill
	\begin{minipage}[h!]{0.49\linewidth}
		\centering{\includegraphics[width=0.7\linewidth]{../pics/days/06-08/IMG_8916.jpg}}
	\end{minipage}
